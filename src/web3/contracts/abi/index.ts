...
export const ROUTER_ABI = [
  {
    "inputs": [
      ...
      },
      {
        ...
        "name": "_listingFeeAmount",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
        "name": "_monthlyFeeAmount",
        "type": "uint256"
      },
      {
        "internalType": "uint256",
  ...
  },
  {
    ...
    "inputs": [
      ...
      {
        "indexed": false,
        "internalType": "enum Router.ProtocolTier",
        "name": "tier",
        "type": "uint8"
      },
      {
  ...
  {
    "inputs": [],
    "name": "VOLATILITY_TIER2_THRESHOLD",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
  ...
  {
    "inputs": [],
    "name": "VOLATILITY_TIER3_THRESHOLD",
    "outputs": [
      {
        "internalType": "uint256",
        "name": "",
    ...
    "outputs": [
      {
        ...
        "internalType": "struct Router.LPPosition[]",
        "name": "",
        "type": "tuple[]"
      }
    ],
    ...
    "outputs": [
      {
        ...
        "internalType": "struct Router.ProtocolData",
        "name": "",
        "type": "tuple"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IILVault",
        "name": "",
        "type": "address"
      }
    ],
...
export const IL_VAULT_ABI = [
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IConstantAMM",
        "name": "",
        "type": "address"
      }
    ],
    ...
    "outputs": [
      {
        "components": [
          ...
          {
            "internalType": "enum ILVault.PositionStatus",
            "name": "status",
            "type": "uint8"
          }
        ],
        "internalType": "struct ILVault.Position",
        "name": "",
        "type": "tuple"
      }
    ],
  ...
  },
  {
    ...
    "outputs": [
      {
        "internalType": "contract IILVoucher",
        "name": "",
        "type": "address"
      }
    ],

...
import { Github, Twitter, Disc as Discord, Droplet } from 'lucide-react';
    ...
    <footer className="py-12 px-6 border-t border-white/10 bg-[#0A0B10]">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        <Link to="/" className="flex items-center gap-2">
          <img src={logo} alt="Conduir" className="w-8 h-8" />
          <span className="font-display font-bold text-lg tracking-tight">Conduir</span>
        </Link>
        
        <div className="flex items-center gap-6 text-slate-400">
          <Link to="/faucet" className="flex items-center gap-1.5 hover:text-blue-400 transition-colors text-sm">
